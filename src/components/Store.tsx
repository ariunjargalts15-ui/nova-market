        ...
        <div className="max-w-[1400px] mx-auto mt-12">
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                      <h2 className="font-display text-2xl font-semibold text-[#0a1b33]">
                        {adminMode ? 'Manage Products' : 'Our Products'}
                                <span className="ml-2 text-sm font-sans font-normal text-slate-400">({filtered.length} items)</span>span>
                      </h2>h2>
          ...
          {filtered.length === 0 ? (
                  <div className="text-center py-24 text-slate-400 font-sans">
                            <div className="text-5xl mb-4">🛍️</div>div>
                            <p className="text-lg font-medium">No products yet.</p>p>
                    {adminMode && <p className="text-sm mt-1">Add your first product above!</p>p>}
                  </div>div>
                ) : (
